...
THREE.IKSolver = ( function () {

	/**
	 * @param {THREE.SkinnedMesh} mesh
	 * @param {Array<Object>} iks
	 */
	function IKSolver( mesh, iks ) {

		this.mesh = mesh;
		this.iks = iks || [];

		var i = this.iks.length;
		while(i--){
			this.iks[i].maxAngle *= Math.torad;
		}

		this.mesh.userData['iks'] = this.iks;
	...
	IKSolver.prototype = {
		...
		constructor: IKSolver,

		/**
		 * Update IK bones.
		 *
		 * @return {THREE.IKSolver}
		 */
		update: function () {
			...
			return function update() {
				...
				for ( var i = 0, il = iks.length; i < il; i++ ) {
					...
					if(ik.targetMesh)target = ik.targetMesh;
		...
		createHelper: function () {
			...
			return new IKHelper( this.mesh, this.mesh.userData.iks );
	...
	function IKHelper( mesh, iks ) {
		...
		this.sphereGeometry = new THREE.SphereBufferGeometry( 0.5, 16, 8 );
	...
	IKHelper.prototype = Object.assign( Object.create( THREE.Object3D.prototype ), {

		constructor: IKHelper,
