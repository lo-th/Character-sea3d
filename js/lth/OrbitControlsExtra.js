...
THREE.OrbitControlsExtra.prototype = Object.assign( Object.create( THREE.OrbitControls.prototype ), {
    ...
    getInfo: function () {
        ...
        //console.log(sph.radius, sph.phi, sph.theta)
       ...
       /* return {
            x:t.x, y:t.y, z:t.z, 
            distance: sph.radius, 
            phi: sph.phi * THREE.Math.RAD2DEG,
            theta: sph.theta * THREE.Math.RAD2DEG
            //distance: Math.floor( sph.radius ), 
            //phi: -Math.floor( sph.phi * THREE.Math.RAD2DEG ) + 90,
            //theta: Math.floor( sph.theta * THREE.Math.RAD2DEG )
        };*/
    ...
    moveCam: function ( o, callback ) {
        ...
        if( o.x===undefined ) o.x = c.x;
        if( o.y===undefined ) o.y = c.y;
        if( o.z===undefined ) o.z = c.z;
        if( o.distance===undefined ) o.distance = c.distance;
        if( o.phi===undefined ) o.phi = c.phi;
        if( o.theta===undefined ) o.theta = c.theta;

        if( o.time===undefined ) o.time = 0;
    	...
    	o.phi = o.phi !== undefined ? o.phi : c.phi;
    	o.theta = o.theta !== undefined ? o.theta : c.theta;

        o.time = o.time !== undefined ? o.time : 0;
        ...
        this.camTween = new TWEEN.Tween( c ).to( o, o.time )
            .delay( o.delay || 0 )
    ...
    orbit: function ( o ) {
        ...
        //cam.s.set( o.distance, o.phi * THREE.Math.DEG2RAD, o.theta * THREE.Math.DEG2RAD );
    	cam.s.makeSafe();
